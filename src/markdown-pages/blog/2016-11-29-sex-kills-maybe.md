...
---
_(Эпистемический статус: быстрый подсчёт, вынесенный из [чата рационалистов](http://lesswrong.ru/slack). Все количественные оценки следует читать как грубые [вычисления Ферми](https://en.wikipedia.org/wiki/Fermi\_problem), а не как подсчёт истинных значений.)_
...
Base rate probability _ (вероятность отсутствия диагноза или что партнёрша обманет про свой статус) _ (всякие дополнительные поправки про социальные слои, регионы, бисексуальность партнёра или склонность партнёрши заниматься сексом с би-мужчинами, шансы прошлых половых контактов с наркоманами)
